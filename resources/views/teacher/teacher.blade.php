        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarExample01">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://www.youtube.com/channel/UC5CF7mLQZhvx8O5GODZAhdA" rel="nofollow"
                  target="_blank">Pending student</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="" target="_blank">libary</a>
              </li>
            </ul>
            ...
            <ul class="navbar-nav d-flex flex-row">
              ...
              <li class="nav-item me-3 me-lg-0">
                <a class="nav-link" href="{{ url('logout') }}" rel="nofollow"
                  target="_blank">
                logout
                </a>
              </li>
              <li class="nav-item me-3 me-lg-0">
                <a class="nav-link" href="{{ url('register') }}" rel="nofollow" target="_blank">
                  Register
                </a>
              </li>
              <li class="nav-item me-3 me-lg-0">
                <a class="nav-link" href="{{ url('login') }}" rel="nofollow" target="_blank">
                  Login
                </a>
              </li>
  {{--             
